...
public struct ABI {
    ...
    public static func encodeParameter(type: SolidityType, value: ABIConvertible) throws -> String {
    ...
    public static func encodeParameters(types: [SolidityType], values: [ABIConvertible]) throws -> String {

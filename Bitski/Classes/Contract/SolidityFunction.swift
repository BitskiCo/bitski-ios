...
public struct SolidityFunctionParameter: SolidityParameter {
    ...
    public init?(_ parameter: ContractJSONRepresentation.Parameter) {
...
public protocol SolidityFunction: class {
    ...
    init?(abiObject: ContractJSONRepresentation.ABIObject, handler: SolidityFunctionHandler)
    ...
    func invoke(_ inputs: ABIConvertible...) -> SolidityInvocation
}
...
public class SolidityConstantFunction: SolidityFunction {
    ...
    public required init?(abiObject: ContractJSONRepresentation.ABIObject, handler: SolidityFunctionHandler) {
    ...
    public func invoke(_ inputs: ABIConvertible...) -> SolidityInvocation {
...
public class SolidityConstructor {
    ...
    public init?(abiObject: ContractJSONRepresentation.ABIObject, handler: SolidityFunctionHandler) {
    ...
    public func invoke(byteCode: EthereumData, parameters: [ABIConvertible]) -> SolidityConstructorInvocation {

...
//
//    public func send(functionName: String, parameters: [WrappedValue], fromAddress from: EthereumAddress) -> Promise<EthereumData> {
//        do {
...
//    }
//
//    //todo: automatically handle conversion to ABIRepresentable value with generics?
//    public func call(functionName: String, parameters: [WrappedValue], block: EthereumQuantityTag = .latest) -> Promise<EthereumData> {
//        do {
